...
parser.add_argument('--seed', type=int, default=1,
                    help='random seed')
parser.add_argument('--data_dir', type=str, default='./dataset/task_MAS',
...
parser.add_argument('--pre_train', type=str, default='../DRN-master/experiment/init_B100_500/model/model_100.pt',
                    help='pre-trained model directory')
parser.add_argument('--pre_train_dual', type=str, default='../DRN-master/experiment/init_B100_500/model/dual_model_100.pt',
...
parser.add_argument('--save', type=str, default='./DRN_MAS/experiment/train_drn_B100_00001/',
                    help='file name to save')
parser.add_argument('--print_every', type=int, default=100,
                    help='how many batches to wait before logging training status')
parser.add_argument('--save_results', type=bool, default=True,
                    help='save output results')
parser.add_argument('--reg_lambda', type=float, default=0.0001, help='Regularization parameter')
