...
parser.add_argument('--seed', type=int, default=1,
                    help='random seed')
parser.add_argument('--data_dir', type=str, default='./origin_task_MAS/',
                    help='dataset directory')
parser.add_argument('--data_train', type=str, default='DF2K',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='task_MAS',
                    help='test dataset name')
parser.add_argument('--data_range', type=str, default='1-200/201-250',
...
parser.add_argument('--pre_train', type=str, default='./premodel/model_div2k_200.pt',
                    help='pre-trained model directory, ./premodel/model_div2k_200.pt')
parser.add_argument('--pre_train_dual', type=str, default='./premodel/dual_model_div2k_200.pt',
                    help='pre-trained dual model directory, /DRN_LwU/experiment/drn_ewc/task_4/model/dual_model_800.pt')
...
parser.add_argument('--lml', type=str, default='ewc',
                    help='lifelong machine learning method')
...
parser.add_argument('--save', type=str, default='./DRN_LwU/experiment/drn_ewc_task5/',
...
parser.add_argument('--reg_lambda', type=float, default=1e-1,
                    help='Regularization parameter,lwu=0.01,ewc=100')
